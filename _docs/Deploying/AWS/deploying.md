...
generated](media/image53.jpg){width="2.655in"
height="2.3839227909011376in"}
...
**[EKS Cluster](#eks-cluster) 4**

> [Prerequisite](#prerequisite) 4
>
> [Role](#role) 4
>
> [Cluster IAM Role](#cluster-iam-role) 4
>
> [Service IAM Role](#service-iam-role) 6
>
> [Node IAM Role](#node-iam-role) 7
>
> [Policy](#policy) 9
>
> [User](#user) 10
>
> [Create the Cluster](#create-the-cluster) 11
>
> [Access the Cluster](#access-the-cluster) 13

**[SingleStore](#_heading=h.2iq8gzs) 13**

> [Cluster Admin Prerequisites](#cluster-admin-prerequisites) 13
>
> [Deployment Prerequisites](#deployment-prerequisites) 13
>
> [Create the Object Definition
> Files](#create-the-object-definition-files) 13
>
> [MemSQL Operator](#memsql-operator) 14
>
> [RBAC](#rbac) 15
>
> [Custom Resource Definition](#custom-resource-definition) 16
>
> [MemSQL Cluster](#memsql-cluster) 17
>
> [Deploy a SingleStore DB Cluster](#deploy-a-singlestore-db-cluster) 18
>
> [Verification](#verification-1) 18
>
> [Install SingleStore Client](#install-singlestore-client) 20
>
> [Access SingleStore DB](#access-singlestore-db) 20
>
> [Backup](#_heading=h.xvir7l) 21

**[Scaling](#scaling) 21**

> [Prerequisites](#prerequisites) 21
>
> [Horizontal Scaling](#horizontal-scaling) 22
>
> [Vertical Scaling](#vertical-scaling) 23
>
> [CPU & Memory](#cpu-memory) 23
>
...
> [Storage](#storage) 25
>
> [Troubleshoot](#troubleshoot) 26

**[Monitoring](#monitoring) 26**

> [Introduction](#introduction-1) 26
>
> [Terminology](#terminology) 27
>
> [High-Level Architecture](#high-level-architecture) 27
>
> [Prerequisites](#prerequisites-1) 27
>
> [Port Configuration](#port-configuration) 29
>
> [Identify Exporter Process](#identify-exporter-process) 29
>
> [Configure the metrics Database](#configure-the-metrics-database) 29
>
> [Create the metrics database and associated
> tables](#create-the-metrics-database-and-associated-tables) 29
>
> [Create monitoring user](#create-monitoring-user) 29
>
> [Create the pipeline](#create-the-pipeline) 30
>
> [The metrics pipeline](#the-metrics-pipeline) 30
>
> [The blobs pipeline](#the-blobs-pipeline) 31
>
> [Troubleshoot the pipeline](#troubleshoot-the-pipeline) 31
>
> [Grafana](#grafana) 31
>
> [Setup](#setup) 31
>
> [Install the Plugin](#install-the-plugin) 32
>
> [Access](#access) 33
>
> [Datasource](#datasource) 34
>
> [Dashboard](#dashboard) 37

**[Rollback/Cleanup](#rollbackcleanup) 39**

> [AKS Cluster](#aks-cluster) 39
>
> [SingleStore DB](#singlestore-db) 40

**[Useful Command](#useful-command) 40**

> [Kubernetes](#kubernetes) 40
>
> [SingleStore](#singlestore-1) 40
...
> cluster health over
> time.![](media/image31.png){width="5.830295275590551in"
