...
## ![](../../assets/img/docs_deploy_aws_media/media/image46.png){width="6.267716535433071in" height="0.4722222222222222in"}
...
generated](../../assets/img/docs_deploy_aws_media/media/image55.png)
...
1.  Add a monitoring MySQL data source with the following settings.
    ...
    ![](../../assets/img/docs_deploy_aws_media/media/image25.png){width="4.941772747156605in" height="3.6718755468066493in"}
...
4.  View the Dashboards
 When all cluster monitoring components are installed, configured, and running, the Grafana dashboards can be used to monitor SingleStore DB cluster health over time.
     ![](../../assets/img/docs_deploy_aws_media/media/image31.png){width="5.830295275590551in" height="3.682292213473316in"}
